...
\begin{tikzpicture}[overlay, remember picture]
   \node[below left] at (current page.north)
      {Hello World!};
\end{tikzpicture}
\end{minted}
\end{minipage}
...
\begin{focus}
   ...
   \blatex{\\usepackage\{tcolorbox\}} \qquad \blatex{\\usepackage\{pgfplots\}}\medskip\\
   \blatex{\\usepackage\{forest\}}
\end{focus}
\begin{onlyenv}<2->
\begin{tikzpicture}[overlay,remember picture]
   \node[below left] at(current page.north east) {\textbullet~Hello World!};
\end{tikzpicture}
\end{onlyenv}
