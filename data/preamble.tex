...
\makeatletter
\appto\input@path{{lib/tikzpingus/tex/}{data/}}
...
\begin{frame}
   \hypertarget<3>{learning:\theLearnings}{}%
   \begin{tikzpicture}[@O]
...
\outro{\label{LAST}\begin{tikzpicture}[@]
   \node[below left,text=white,opacity=.9] at(current page.north east) {\scriptsize\href{https://github.com/EagleoutIce/institute-2023-presentation}{github.com/EagleoutIce/institute-2023-presentation}};
\end{tikzpicture}}
