...
\outro{\label{LAST}\begin{tikzpicture}[@]
   \node[below left] at(current page.north east) {\href{https://github.com/EagleoutIce/institute-2023-presentation}{github.com/EagleoutIce/institute-2023-presentation}};
\end{tikzpicture}}
